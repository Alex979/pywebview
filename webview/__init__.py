...
def create_window(title, url=None, html=None, js_api=None, width=800, height=600, x=None, y=None,
                  ...
                  transparent=False, text_select=False, preserve_controls=False):
    """
    ...
    :param preserve_controls: Keep default window controls (maximimize, minimize, close) on frameless windows (reequired OS: MacOS)
    ...
    window = Window(uid, make_unicode(title), url, html,
                    ...
                    js_api, text_select, transparent, preserve_controls)
